...
const messages = [
  ...
  `The "L" in "LLM" stands for "Large". These models take up GIGABYTES of space.`,
  ...
  `Your friend (or your browser) might be suspicious of your intentions.`,
  `In my case, I just want to know what LLMs we can put on your browser.`,
  `Hey, {ALLOCATED_GB} gigabytes--not bad!`,
  `You can run a lot of nice, general-purpose LLMs with that.`,
  `I'm also checking for a few other things like...`,
  `Can I write values to the memory and read them back?`,
  `(Call me paranoid, but I gotta prove it's real memory I can actually use.)`,
  ...
  `We don't need no stinking cloud, my friend.`, 
  `Got the power right here!`,
  ...
  `You can lend your {ALLOCATED_GB} gigabytes of video memory to some indie dev.`,
